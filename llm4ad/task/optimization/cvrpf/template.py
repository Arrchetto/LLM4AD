...
task_description = (
    ...
    "First assign every customer to at most max_vehicles capacity-feasible groups, using "
    "reassignment when necessary; only then optimize customer order within each group. "
