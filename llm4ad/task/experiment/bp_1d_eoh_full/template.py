...
task_description = (
    ...
    "Derive the packing strategy from the item sizes and capacity, and explore "
    "structurally different complete algorithms across candidates. A purported "
    "improvement phase changes the primary objective only when it reduces the "
    "number of bins; merely rearranging items without reducing that count is "
    "not an objective improvement. "
