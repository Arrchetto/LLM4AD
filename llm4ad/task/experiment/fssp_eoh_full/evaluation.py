"""Evaluator for complete EoH solvers on the FSSP protocol."""
...
class FSSPEoHFullEvaluation(Evaluation):
    """Evaluate complete EoH flow-shop solvers on a frozen Taillard split."""
